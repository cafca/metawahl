...
import "../../index.css"
import { Icon, Menu, Modal, Button, Confirm } from "semantic-ui-react"

import { API_ROOT, makeJSONRequest, adminKey } from "../../config/"
    ...
    return (
      <Menu>
        {this.props.tag != null && (
          <Menu.Item
            onClick={() => {
              this.setState({ tagRemoveOpen: true })
            }}
            style={{ color: "#999" }}
          >
        ...
        <Menu.Menu position="right" style={{ borderLeft: "1px solid #ccc" }}>
          <WikidataTagger
        ...
        {this.state.selectedTag != null && (
          ...
          >
            <Modal.Content>
              <p>
                Möchtest du das Tag "{this.state.selectedTag.label}" bei all
                diesen Thesen hinzufügen oder entfernen?
              </p>
            </Modal.Content>
            <Modal.Actions>
              <Button
