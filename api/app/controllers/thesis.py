...
@thesis_bp.route("/thesis/<string:thesis_id>")
@cache_filler()
@cache.cached()
def thesis_view(thesis_id: str):
...
@thesis_bp.route("/thesis/<string:thesis_id>/tags/", methods=["POST"])
def thesis_tags_post(thesis_id: str):
